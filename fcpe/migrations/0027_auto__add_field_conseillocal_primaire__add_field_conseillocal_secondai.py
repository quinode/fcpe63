...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ConseilLocal.primaire'
        db.add_column('fcpe_conseillocal', 'primaire', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'ConseilLocal.secondaire'
        db.add_column('fcpe_conseillocal', 'secondaire', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ConseilLocal.primaire'
        db.delete_column('fcpe_conseillocal', 'primaire')

        # Deleting field 'ConseilLocal.secondaire'
        db.delete_column('fcpe_conseillocal', 'secondaire')
