...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Adherent.telephone'
        db.add_column('fcpe_adherent', 'telephone', self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True), keep_default=False)

        # Adding field 'Adherent.mobile'
        db.add_column('fcpe_adherent', 'mobile', self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True), keep_default=False)

        # Adding field 'Adherent._cp'
        db.add_column('fcpe_adherent', '_cp', self.gf('django.db.models.fields.CharField')(default='', max_length=5, blank=True), keep_default=False)

        # Adding field 'Adherent._ville'
        db.add_column('fcpe_adherent', '_ville', self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Adherent.telephone'
        db.delete_column('fcpe_adherent', 'telephone')

        # Deleting field 'Adherent.mobile'
        db.delete_column('fcpe_adherent', 'mobile')

        # Deleting field 'Adherent._cp'
        db.delete_column('fcpe_adherent', '_cp')

        # Deleting field 'Adherent._ville'
        db.delete_column('fcpe_adherent', '_ville')
