...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Engagement.adhesion_primaire'
        db.add_column('fcpe_engagement', 'adhesion_primaire', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Engagement.adhesion_primaire'
        db.delete_column('fcpe_engagement', 'adhesion_primaire')
