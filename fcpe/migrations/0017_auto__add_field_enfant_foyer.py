...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Enfant.foyer'
        db.add_column('fcpe_enfant', 'foyer', self.gf('django.db.models.fields.related.ForeignKey')(default=827512, to=orm['fcpe.Adherent']), keep_default=False)
    ...
    models = {
        ...
        'fcpe.enfant': {
            ...
            'foyer': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['fcpe.Adherent']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
