...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Adherent.au_bureau'
        db.delete_column('fcpe_adherent', 'au_bureau')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Adherent.au_bureau'
        db.add_column('fcpe_adherent', 'au_bureau', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)
    ...
    models = {
        ...
        'fcpe.enfant': {
            ...
            '_foyer': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
        ...
        'fcpe.personne': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'listes': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['django_mailman.List']", 'through': "orm['fcpe.InscriptionMailing']", 'symmetrical': 'False'}),
            'nom': ('django.db.models.fields.CharField', [], {'max_length': '100', 'blank': 'True'}),
