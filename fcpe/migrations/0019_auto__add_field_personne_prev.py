...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Personne.prev'
        db.add_column('fcpe_personne', 'prev', self.gf('picklefield.fields.PickledObjectField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Personne.prev'
        db.delete_column('fcpe_personne', 'prev')
    ...
    models = {
        ...
        'fcpe.personne': {
            ...
            'prenom': ('django.db.models.fields.CharField', [], {'max_length': '100', 'blank': 'True'}),
            'prev': ('picklefield.fields.PickledObjectField', [], {'null': 'True', 'blank': 'True'}),
