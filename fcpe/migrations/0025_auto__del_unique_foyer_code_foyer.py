...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing unique constraint on 'Foyer', fields ['code_foyer']
        db.delete_unique('fcpe_foyer', ['code_foyer'])


    def backwards(self, orm):
        
        # Adding unique constraint on 'Foyer', fields ['code_foyer']
        db.create_unique('fcpe_foyer', ['code_foyer'])
