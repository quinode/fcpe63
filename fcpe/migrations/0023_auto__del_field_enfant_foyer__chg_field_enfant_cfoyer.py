...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Enfant.foyer'
        db.delete_column('fcpe_enfant', 'foyer_id')

        # Changing field 'Enfant.cfoyer'
        db.alter_column('fcpe_enfant', 'cfoyer_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['fcpe.Foyer']))


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'Enfant.foyer'
        raise RuntimeError("Cannot reverse this migration. 'Enfant.foyer' and its values cannot be restored.")

        # Changing field 'Enfant.cfoyer'
        db.alter_column('fcpe_enfant', 'cfoyer_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['fcpe.Foyer'], null=True))
    ...
    models = {
        ...
        'fcpe.foyer': {
            ...
            'code_foyer': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '11', 'blank': 'True'}),
            'commune': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['communes.Commune']", 'null': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        'fcpe.personne': {
