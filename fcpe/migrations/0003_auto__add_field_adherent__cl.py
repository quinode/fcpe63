...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Adherent._cl'
        db.add_column('fcpe_adherent', '_cl', self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Adherent._cl'
        db.delete_column('fcpe_adherent', '_cl')
