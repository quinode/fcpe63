...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ConseilLocal.location'
        db.add_column('fcpe_conseillocal', 'location', self.gf('django.contrib.gis.db.models.fields.PointField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ConseilLocal.location'
        db.delete_column('fcpe_conseillocal', 'location')
