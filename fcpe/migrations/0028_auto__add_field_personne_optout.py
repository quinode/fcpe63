...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Personne.optout'
        db.add_column('fcpe_personne', 'optout', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Personne.optout'
        db.delete_column('fcpe_personne', 'optout')
