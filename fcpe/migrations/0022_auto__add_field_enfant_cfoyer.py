...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Enfant.cfoyer'
        db.add_column('fcpe_enfant', 'cfoyer', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['fcpe.Foyer'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Enfant.cfoyer'
        db.delete_column('fcpe_enfant', 'cfoyer_id')
    ...
    models = {
        ...
        'fcpe.enfant': {
            ...
            'cfoyer': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['fcpe.Foyer']", 'null': 'True', 'blank': 'True'}),
