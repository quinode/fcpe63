...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Adherent.cfoyer'
        db.add_column('fcpe_adherent', 'cfoyer', self.gf('django.db.models.fields.CharField')(default='', max_length=11, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Adherent.cfoyer'
        db.delete_column('fcpe_adherent', 'cfoyer')
