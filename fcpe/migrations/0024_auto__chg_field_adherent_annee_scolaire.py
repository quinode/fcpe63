...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('fcpe_adherent', 'annee_scolaire_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['fcpe.AnneeScolaire'], null=True))


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'Adherent.annee_scolaire'
        raise RuntimeError("Cannot reverse this migration. 'Adherent.annee_scolaire' and its values cannot be restored.")
