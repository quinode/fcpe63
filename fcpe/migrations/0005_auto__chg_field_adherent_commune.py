...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Adherent.commune'
        db.alter_column('fcpe_adherent', 'commune_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['communes.Commune'], null=True))


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'Adherent.commune'
        raise RuntimeError("Cannot reverse this migration. 'Adherent.commune' and its values cannot be restored.")
