...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('fcpe_foyer', (
            ...
            ('annee_scolaire', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['fcpe.AnneeScolaire'], null=True, blank=True)),
            ('code_foyer', self.gf('django.db.models.fields.CharField')(unique=True, max_length=11, blank=True)),
        ))
        db.send_create_signal('fcpe', ['Foyer'])

        # Adding field 'Adherent.foyer'
        db.add_column('fcpe_adherent', 'foyer', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['fcpe.Foyer'], null=True, blank=True), keep_default=False)
