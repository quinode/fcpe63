...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Adherent.clocal'
        db.delete_column('fcpe_adherent', 'clocal')


    def backwards(self, orm):
        
        # Adding field 'Adherent.clocal'
        db.add_column('fcpe_adherent', 'clocal', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)
